...
<head>
    ...
    <title>Storage Management System | View Requests</title>
</head>
<body>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <?php
                    ...
                    echo successMessage();
                ?>
                <h2 class="text-center pb-3">View Requests</h2>
                <h3 class="pb-3 text-center">Pending Requests</h3>
                <div class="container-fluid">
                    <table id="table1" class="table table-hover table-responsive-lg table-striped col-sm-12">
                        <thead>
                        <tr>
                            <th scope="col">#</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a onclick="javascript:return confirm('Are You Sure You Want To Make Item Returned?');" class="btn btn-success" href="returned.php?rid=<?php echo $id;?>" role="button">Return</a>
                                    </div>
                                </td>
                            </tr>
                        <?php }?>
                ...
                <h3 class="pb-3 text-center">Returned Items</h3>
                <div class="container-fluid">
                    <table id="table3" class="table table-responsive-lg table-hover table-striped col-sm-12">
                        <thead>
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col">Item Name</th>
                        ...
                        <tbody>
                        <?php
                        $sql = "select * from requests where requeststatus = 'Returned'";
                        $query = mysqli_query($con,$sql);
                        $no = 0;
                        while($row = mysqli_fetch_assoc($query)){
                            $id = $row['id'];
