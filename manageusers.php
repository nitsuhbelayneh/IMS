...
<head>
    ...
    <title>Storage Management System | Manage Users</title>
</head>
<body>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <?php
                    ...
                    echo successMessage();
                ?>
                <h2 class="text-center pb-3">Manage Users
                ...
                <div class="container-fluid">
                    <?php
                    $no = 0;
                    $sql = "select * from credentials where role = 'user' order by username asc";
                    $query = mysqli_query($con,$sql);
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a class="btn btn-primary" href="edituser.php?eid=<?php echo $row['id'];?>">Edit</a>
                                            <a onclick="javascript:return confirm('Are You Sure You Want To Delete?');" class="btn btn-danger" href="manageusers.php?did=<?php echo $row['id'];?>" role="button">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #343a40;color: #ffffff;">
                    <h3 class="modal-title text-center" id="exampleModalLabel">Add User</h3>
