...
<head>
    ...
    <title>Storage Management System | Store Manager Message</title>
</head>
<body>
    <div class="wrapper" style="height:auto;">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h2 class="text-center pb-3">Messages</h2>
                <?php
                    echo Message();
                    echo successMessage();
                ?>
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="row mt-5">
                                ...
                                <div class="col-sm-10 col-md-8 col-lg-4 bg-black-50">
                                    <form action="sendadminmessage.php" method="post">
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    ...
                                    while($row = mysqli_fetch_assoc($query)){
                                        ...
                                        <?php if($status == 'New'){?>
                                            ...
                                            <p class="font-weight-bold lead"><?php echo $message;?>
                                                <a  href="storemanagermessage.php?mid=<?php echo $id?>" class="badge badge-primary pull-right">Mark as read</a>
                                                <a onclick="javascript:return confirm('Are You Sure You Want To Clear?');" href="storemanagermessage.php?cid=<?php echo $id?>" class="badge badge-danger pull-right">Clear</a>
                                            </p>
                                            <hr>
                                        <?php }else{
                                            ?>
                            ...
                            if(isset($_GET['mid'])){
                                ...
                                if($query){
                                    ...
                                    echo "
                                    <script type='text/javascript'>window.location='storemanagermessage.php'</script>                                    
                                    ";
                                }else{
