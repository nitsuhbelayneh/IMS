...
if(isset($_POST["submit"])){
    ...
    if(empty($username) || empty($firstname) || empty($lastname) || empty($email) || empty($email) || empty($password) || empty($cpassword)){
        ...
        redirect_to('managestorekeepers.php');
        exit();
    }
    ...
    elseif ($username == $existingusername){
        ...
        if ($query1){
            $_SESSION['successMessage'] = "Store Keeper Successfully Registered";
            redirect_to('managestorekeepers.php');
        }
    }
...
<head>
    ...
    <title>Storage Management System | Manage Store Keepers</title>
</head>
<body>
    <div class="wrapper" style="height:auto;">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="">
                    <a href="managerequests.php"><i class="fa fa-registered"></i> Manage Requests <span style="float: right;" class="badge badge-pill badge-primary mt-1 ">
                            <?php
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <?php
                    ...
                    echo successMessage();
                ?>
                <h2 class="text-center pb-3">Manage Store Keepers
                ...
                <div class="container-fluid">
                    <?php
                    $no = 0;
                    $sql = "select * from credentials where role = 'storekeeper' order by username asc";
                    $query = mysqli_query($con,$sql);
                    ...
                    <table id="table1" class="table table-responsive-lg table-hover table-striped col-sm-12">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a class="btn btn-primary" href="editstorekeeper.php?eid=<?php echo $row['id'];?>">Edit</a>
                                            <a onclick="javascript:return confirm('Are You Sure You Want To Delete?');" class="btn btn-danger" href="managestorekeepers.php?did=<?php echo $row['id'];?>" role="button">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php
                        ...
                        if(isset($_GET['did'])){
                            ...
                            $query = mysqli_query($con,$sql);
                            if($query){
                                $_SESSION['successMessage'] = "Store Keeper Successfully deleted";
                                echo "
                                <script>
                                    location.href='managestorekeepers.php';
                                </script>";
                            }
                        }
                        ?>
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #343a40;color: #ffffff;">
                    <h3 class="modal-title text-center" id="exampleModalLabel">Add Store Keeper</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="managestorekeepers.php" method="post">
                        <div class="form-row">
                        ...
                        <button name="submit" style="float: right;" type="submit" class="btn btn-primary mt-4">Add Store Keeper</button>
                    </form>
                </div>
            </div>
        </div>
